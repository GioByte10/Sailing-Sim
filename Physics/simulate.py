...
def run_simulation(boat_state, haptic_state, control_state, env, params):
    """
    ...
    """
    # Compute forces
    tau_total_k1, sail_lift, sail_drag = compute_total_forces(boat_state, haptic_state, control_state, env, params)
    
    # Integrate boat motion
    boat_state_k1 = euler_integrate(boat_state, tau_total_k1, params) 
    # Compute motor torques
    motor_command = compute_motor_torques(boat_state, tau_total_k1, sail_lift, sail_drag, haptic_state, params)
